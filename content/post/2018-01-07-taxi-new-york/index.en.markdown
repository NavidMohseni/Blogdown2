...
summary: ''
authors: []
lastmod: '2019-12-10T22:26:22+03:30'
featured: no
image:
  caption: ''
  focal_point: ''
...
We are going to do the datacamp R project: New York Taxi.\
In this project, Working with the data from a large number of taxi journeys in New York from 2013.
