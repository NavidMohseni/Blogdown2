...
summary: ''
authors: []
lastmod: '2019-12-24T22:06:44+03:30'
featured: no
image:
  caption: ''
  focal_point: ''
...
We are going to do the datacamp R project: Heart Rate.\
In this project, the relationship between the maximum heart rate one can achieve during exercise and the likelihood of developing heart disease had been analyzed. Using multiple logistic regression, you will handle the confounding effects of age and gender. This project uses the Cleveland heart disease dataset.
